...
class combinedAtomList(object):
            ...
            if norm == 'Standard':
                ...
                if normSet == [['', 'CA']]:
                    ...
                    if metric == 'loss':
                        ...
                        name = r"\text{Custom-normalised}\ D_\text{mean}^{-,\,\rho}\text{(atom)}\)"
                    else:
            ...
            if norm == 'Standard':
                ...
                if normSet == [['', 'CA']]:
                    ...
                    if metric == 'loss':
                        ...
                        name = r"$\mathrm{Custom-normalised}\ D_\mathrm{mean}^{-,\,\rho}\mathrm{(atom)}$"
                    else:
                        name = 'Custom-normalised ' + metric
            else:
                name = norm + ' ' + metric
    ...
    def getTopAtomsStackedBarplot(self,
        ...
        for i, (k, color) in enumerate(zip(plotDic.keys(), colors)):
    ...
    def checkSpecificAtomsExist(self,
        ...
        count = 0
        for a in AtomSet:
            atom = self.getAtom(restype=a[0], atomtype=a[1],
                                printOutput=False)
            if len(atom) > 0:
                count += 1
        if count == 0:
    ...
    def checkCalphaAtomsExist(self,
        ...
        for res in self.aminoAcids:
            atom = self.getAtom(restype=res, atomtype='CA',
                                printOutput=False)
            if len(atom) == 0:
                count += 1
